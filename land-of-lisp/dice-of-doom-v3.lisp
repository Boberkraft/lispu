(load "C:\\Users\\Bobi\\Desktop\\lispu\\dice-of-doom-v2.lisp")
(load "C:\\Users\\Bobi\\Desktop\\lispu\\serwer.lisp")
(load "C:\\Users\\Bobi\\Desktop\\lispu\\macro.lisp")


(defparameter *board-width* 2000)
(defparameter *board-height* 2000)
...
(defun dod-request-handler (path header params)
  (if (equal path "game.html")
      (progn (princ "<!doctype html>")
             (tag center ()
               (princ "Welcome to the DICE OF DOOM!")
               (tag br ())
...
(defun web-handle-human (pos)
  (cond ((not pos)
        ...
        (t
         (setf *cur-game-tree*
               (pick-change-branch (cadr tree) pos))
